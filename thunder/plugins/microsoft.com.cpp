...
extern "C" resposta getmatch(const string url) {
	...
	if (	( (url.find("windowsupdate.com") != string::npos) or (url.find("update.microsoft.com") != string::npos) or
				(url.find("download.microsoft.com") != string::npos) or (url.find("dlservice.microsoft.com")!= string::npos) ) and
			( (url.find(".cab") != string::npos) or (url.find(".exe") != string::npos) or (url.find(".iso") != string::npos) or
				(url.find(".zip") != string::npos) or (url.find(".psf") != string::npos) or (url.find(".txt") != string::npos) or
		       		  (url.find(".crt") != string::npos)	) and
