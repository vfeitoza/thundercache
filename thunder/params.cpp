...
{
    SetConfig("CACHEDIR", "/thunder");
    SetConfig("PLUGINSDIR", "/etc/thunder/plugins");
    SetConfig("MYSQL_HOST", "localhost");
    SetConfig("MYSQL_USER", "root");
    SetConfig("MYSQL_PASS", "");
    SetConfig("MYSQL_DB", "thunder");
...
{
    cout << endl << "# Using Thunder config: " << cfgfile << endl << endl;
...
void Params::Usage()
{
    cout << endl << "Usage: thunder [Options]" << endl << endl;
    cout << "Thunder Version " << VERSION << endl << endl;
